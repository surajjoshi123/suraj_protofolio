    ...
    render() {
        ...
        return (
            <div className="sidebar">
                ...
                <h1><Link smooth to="/#start" className="h1_links">Suraj joshi</Link></h1>

                <img src={logo} />
                <p style={{ color: 'black', fontWeight: 'bold' }} className="gmail"><a href="https://mail.google.com/mail/u/0/#inbox?compose=CllgCJftvBffjPmxWxvfHWRHWnhTbpQgPxBxvkcnPpFpFqbhrXMCHXSJTsCXCVLsQzgRcVLpnPL" rel="opener noreferrer" target="_blank" className="fa fa-envelope"></a> surajjoshi.nvli@gmail.com </p>
                ...
                <div className="flip-card-back">
                    <ul className="sidebar-nav">
                        ...
                        <li className="sidebar-nav-icons"> <a href="mailto:surajjoshi.nvli@gmail.com" rel="opener noreferrer" target="_blank" className="fa fas fa-envelope fa-lg"></a></li>
