                ...
                <Carousel className={classes.carousel} dynamicHeight infiniteLoop={true} interval={6000} useKeyboardArrows={true} transitionTime={1700} emulateTouch showArrows={false} autoPlay showStatus={false} showThumbs={false} >
                    <div className={classes.image_container} >
                        ...
                        <div className={classes.h1}>
                            <h1 >I'm Suraj</h1>
                            <a href="https://drive.google.com/file/d/1lDovdrDo15cqTodIJ-BGv3tvHL1o6xPk/view?usp=share_link" rel="opener noreferrer" target="_blank">VIEW CV   <FaArrowCircleDown /></a>
                        </div>
                    </div>
                    <div className={classes.image_container}>
                        ...
                        <div className={classes.h2}>
                            ...
                            <h1>THINGS!!</h1>
                            <a href="https://github.com/surajjoshi123" rel="opener noreferrer" target="_blank">VIEW PROJECTS   <GoProject /></a>
                        </div>
                    </div>
                    {/* <div className={classes.image_container}>
